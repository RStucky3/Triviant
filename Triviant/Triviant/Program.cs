...
namespace Triviant
{
    class Program
    {
        ...
        static int[] catogorieënGehad = {0, 0, 0, 0, 0, 0 };
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n" + "Klik op enter om de dobbelsteen te rollen!");
            Console.ReadLine();
            ...
            do
            {
                ...
                Console.WriteLine("\n" + "Klik op enter om de dobbelsteen weer te rollen!");
                Console.ReadLine();

                categorienum = dobbelsteen.Dobbel();
                for (int i = 0; i <= catogorieënGehad.Length; i++)
                {
                    if (categorienum == catogorieënGehad[i])
                    {
                        categorienum = dobbelsteen.Dobbel();
                    }
                }
